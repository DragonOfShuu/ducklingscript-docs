...
[//]: # (Replace ../wip_page with /docs/debugging-commands#expression_eval later.)
All simple commands that don't already [evaluate](../wip-page) their arguments can use the dollar sign operator. This turns the argument into an expression that will evaluated.

[//]: # (Replace ../wip_page with /docs/debugging-commands#expression_eval later.)
This allows you to write mathematical expressions, or use variables; you can read more of that [here](../wip-page).
...
REPEAT 10
    ...
    STRING bar
```
*More info on `REPEAT` [here](/docs/flow-control#for_loops).