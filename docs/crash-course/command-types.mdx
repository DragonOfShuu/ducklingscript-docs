...
### Examples
<Tabs>
  <TabItem value="math_example" label="Math" default>
    DucklingScript
    ```
    $CTRL 1+1
    ```
  ...
  <TabItem value="string_example" label="String Concatenation">
    DucklingScript
    ```
    $STRING "Hello " + "world!"
    ```
  ...
  <TabItem value="var_example" label="Variable">
    DucklingScript
    ```
...
### Example
<Tabs>
  <TabItem value='repeat_example' label='Repeat'>
    DucklingScript:
    ```
