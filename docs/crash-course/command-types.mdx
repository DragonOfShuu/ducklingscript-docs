...
### Examples
<Tabs>
  <TabItem value="example1" label="Math" default>
    DucklingScript
    ```
    $CTRL 1+1
    ```
  ...
  <TabItem value="example2" label="String Concatenation">
    DucklingScript
    ```
    $STRING "Hello " + "world!"
    ```
  ...
  <TabItem value="example3" label="Variable">
    DucklingScript
    ```
...
### Example
<Tabs>
  <TabItem value='example1' label='Repeat'>
    DucklingScript:
    ```
