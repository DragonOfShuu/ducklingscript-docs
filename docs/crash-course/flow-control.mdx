...
:::info
Our white-coated web feet have again asked us to place a bit of info here to let you know that DucklingScript does not support checking if you have compiled code BEFORE the `REPEAT` command, which means our ducks won't notice any syntax issues caused by this.
:::
